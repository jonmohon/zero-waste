 ...
 * Redesigned to match the artifact aesthetic with deep green primary,
 * accent green, and Montserrat/Open Sans typography.
 *
...
export function Footer() {
  return (
    <footer className="border-t border-primary/8 bg-surface">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Quick links */}
          <div>
            <h3 className="font-heading text-[11px] font-bold uppercase tracking-[0.15em] text-primary">
              Quick Links
            </h3>
        ...
        {/* Copyright */}
        <div className="mt-12 border-t border-primary/8 pt-6 text-center">
